...
**Portfolio management made simple for everyday investors.**

Built for the Goldman Sachs x UT Dallas 2026 Hackathon.
...
- **Market Context**: Real-time explanations of what's happening and why
- **Scenario Planning**: Explore "what-if" scenarios (market crash, inflation, big purchase)
- **Plain English**: Every recommendation explained in simple terms
- **Action-Oriented**: Clear next steps, not just information overload
...
Goldman Sachs x UT Dallas 2026 - May 2-3, 2026
